...
export default function ReelsPage() {
    ...
    const fetchReels = async () => {
        try {
            ...
            const reelPosts = (data.posts || []).filter(
                (post: Reel) =>
    ...
    return (
        <main className="fixed left-0 right-0 top-[0px] bottom-[80px] bg-black text-white overflow-hidden flex items-center justify-center">
            <section className={`relative h-full w-full md:max-w-[400px] overflow-hidden bg-black transform transition-all duration-500 ease-out ${direction === "down"
